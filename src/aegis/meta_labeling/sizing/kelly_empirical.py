...
def test_b_1_1_kelly_classical_coin_toss():
    ...
    assert abs(f_star - 0.2) < 0.05, f"B-1-1 FAILED: Cần f* xấp xỉ 0.2, nhưng nhận được {f_star}"
    print("✅ [TASK B-1-1] solve_empirical_kelly_fraction PASSED! (Khớp hoàn hảo công thức Kelly kinh điển)")
